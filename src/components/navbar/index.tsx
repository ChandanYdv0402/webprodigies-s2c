                ...
                <div className="flex items-center gap-2 backdrop-blur-xl bg-white/[0.08]
                    ...
                    {tabs.map((t) => (
                        <Link
                            key={t.label}
                            href={t.href}
                            className={['group inline-flex items-center gap-2 rounded-full px-4 py-2 text-sm transition', `${pathname}?project=${projectId}` === t.href ? 'bg-white/[0.12] text-white border border-white/[0.16] backdrop-blur-sm'
                                : 'text-zinc-400 hover:text-zinc-200 hover:bg-white/[0.06] border-white/[0.16] hover:border-transparent'
                            ].join(' ')}
                        >
                            <span className={
